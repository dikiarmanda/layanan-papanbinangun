...
<div style="background:var(--white);padding:1.25rem;border-radius:6px;border:1px solid var(--cream-dark);max-width:720px">
  ...
  <p><strong>Kurir:</strong> <?= esc($order['kurir']) ?> <?= esc($order['layanan_kurir']) ?> — <?= format_rupiah($order['ongkos_kirim']) ?></p>
