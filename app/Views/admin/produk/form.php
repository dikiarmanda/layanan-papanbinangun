...
<form method="post" enctype="multipart/form-data"
  ...
  <div class="form-group"><label>Gambar</label><input type="file" name="gambar" accept="image/*" class="form-control">
  </div>
  <?php if (!empty($produk['gambar'])): ?>
    <img src="<?= media_url($produk['gambar']) ?>" style="max-width:200px;margin-bottom:1rem" alt="">
  <?php endif; ?>
