...
<div style="background:var(--white);padding:1.25rem;border-radius:6px;border:1px solid var(--cream-dark);max-width:640px">
  ...
  <p><strong>Paket:</strong> <?= esc($reservasi['paket_nama']) ?></p>
  ...
  <form method="post" action="<?= site_url('admin/reservasi/' . $reservasi['id'] . '/status') ?>" style="margin-top:1.25rem">
    <?= csrf_field() ?>
